...
$.wikiLoveOptions.defaultBackgroundColor = "rgba(191,234,181,.2)";
$.wikiLoveOptions.defaultBorderColor = "rgba(18,152,34,.47)";
/*
 ...
 */
// 默认星章补充
$.wikiLoveOptions.types.barnstar.subtypes.userpage = {
    fields: ["message"],
    option: "用户页星章",
...
$.wikiLoveOptions.types.barnstar.subtypes.template = {
    fields: ["message"],
    option: "模板星章",
...
$.wikiLoveOptions.types.barnstar.subtypes.bravery = {
    fields: ["message"],
    option: "勇气星章",
...
$.wikiLoveOptions.types.barnstar.subtypes.helper = {
    fields: ["message"],
    option: "帮手星章",
...
$.wikiLoveOptions.types.barnstar.subtypes.neweditor = {
    fields: ["message"],
    option: "优秀新人星章",
