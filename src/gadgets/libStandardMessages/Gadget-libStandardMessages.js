...
(() => {
    ...
    mw.messages.set({
        ...
        user_talk: wgULS("用户讨论", "使用者討論", null, null, "用戶討論"),
        project: "萌娘百科",
        project_talk: wgULS("萌娘百科讨论", "萌娘百科討論"),
        file: wgULS("文件", "檔案"),
        file_talk: wgULS("文件讨论", "檔案討論"),
        mediawiki: wgULS("界面消息", "介面訊息"),
        mediawiki_talk: wgULS("界面消息讨论", "介面訊息討論"),
        template: "模板",
        template_talk: wgULS("模板讨论", "模板討論"),
        help: wgULS("帮助", "說明"),
        help_talk: wgULS("帮助讨论", "說明討論"),
        category: wgULS("分类", "分類"),
        category_talk: wgULS("分类讨论", "分類討論"),
        creation: wgULS("萌娘创作", "萌娘創作"),
        creation_talk: wgULS("萌娘创作讨论", "萌娘創作討論"),
        document: wgULS("文档", "文檔"),
        document_talk: wgULS("文档讨论", "文檔討論"),
        draft: "草稿",
        draft_talk: wgULS("草稿讨论", "草稿討論"),
        widget: "微件",
        widget_talk: wgULS("微件讨论", "微件討論"),
        timedtext: "TimedText",
    ...
    mw.config.set({
        libLocalizedNamespaces: {
            ...
            114: mw.msg("creation"),
            115: mw.msg("creation_talk"),
            116: mw.msg("document"),
            117: mw.msg("document_talk"),
            118: mw.msg("draft"),
            119: mw.msg("draft_talk"),
            274: mw.msg("widget"),
