 ...
 * 请尊重萌娘百科著作权，以下代码复制需要注明原自萌娘百科，并且附上URL地址 http://zh.moegirl.org.cn/MediaWiki:Gadget-site-js.js
...
(async () => {
    ...
    if (!wgUserGroups.includes("autoconfirmed")) {
        ...
        } else if (wgNamespaceNumber === 118) { // 草稿命名空间
            watermark("草稿页面，内容未经审核<br/>不代表萌娘百科立场", 300);
        }
    }
})();
