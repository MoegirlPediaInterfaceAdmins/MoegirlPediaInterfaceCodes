 ...
 * Options:
 *     polyfillFeature: String.prototype.trim
 *     polyfillAliases: default-3.3, default-3.4, default-3.5, default-3.6, default, es5, modernizr:es5string, blissfuljs
 *     browserslist: defaults, Chrome >= 132
 *     polyfillBrowsers: android: <59, bb: *, chrome: <59, edge: <15, edge_mob: <15, firefox: <52, firefox_mob: <52, ie: *, ie_mob: *, ios_chr: <12.1, ios_saf: <12.1, op_mini: *, op_mob: *, opera: <53, safari: <12.1, samsung_mob: *
 */
(() => {

// Polyfill String.prototype.trim start
...
// Polyfill _ESAbstract.TrimString start
...
// Polyfill _ESAbstract.TrimString end
...
// Polyfill String.prototype.trim end
