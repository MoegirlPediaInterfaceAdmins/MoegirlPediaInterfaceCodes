 ...
 * Options:
 *     polyfillFeature: String.prototype.trimStart
 *     polyfillAliases: es2019
 *     browserslist: defaults, Chrome >= 132
 *     polyfillBrowsers: android: <66, bb: *, chrome: <66, edge: <79, edge_mob: *, firefox: <61, firefox_mob: <61, ie: *, ie_mob: *, ios_chr: <12.1, ios_saf: <12.1, op_mini: *, op_mob: *, opera: <53, safari: <12.1, samsung_mob: *
 */
(() => {

// Polyfill String.prototype.trimStart start
...
// Polyfill String.prototype.trimStart end
