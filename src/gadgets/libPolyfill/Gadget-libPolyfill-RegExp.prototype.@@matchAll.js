 ...
 * Options:
 *     polyfillFeature: RegExp.prototype.@@matchAll
 *     polyfillAliases: es2020
 *     browserslist: defaults, Chrome >= 132
 *     polyfillBrowsers: android: *, bb: *, chrome: <73, edge: <79, edge_mob: *, firefox: <67, firefox_mob: <67, ie: *, ie_mob: *, ios_chr: <73, ios_saf: <13, op_mini: *, op_mob: *, opera: <60, safari: <13, samsung_mob: *
 */
(() => {
