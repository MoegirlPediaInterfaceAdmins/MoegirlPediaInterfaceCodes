...
function CreateMethodProperty(O, P, V) {undefined
...
function ToInteger(argument) {undefined
...
function ToLength(argument) {undefined
...
function LengthOfArrayLike(obj) {undefined
...
function ToNumber(argument) {undefined
...
function ToIntegerOrInfinity(argument) {undefined
	// 1. Let number be ? ToNumber(argument).
...
|----------------------------------------------------------------------------------------------------------------------------------------------------|
*/
function ToObject(argument) {undefined
...
function Call(F, V /* [, argumentsList] */) {undefined
...
function IsCallable(argument) {undefined
...
// 7.3.9. GetMethod ( V, P )
function GetMethod(V, P) {undefined
	// 1. Assert: IsPropertyKey(P) is true.
...
function OrdinaryToPrimitive(O, hint) {undefined
	// 1. Assert: Type(O) is Object.
...
function ToPrimitive(input /* [, PreferredType] */) {undefined
...
|---------------|--------------------------------------------------------|
*/
function ToString(argument) {undefined
	switch(Type(argument)) {
		case 'symbol':
			throw new TypeError('Cannot convert a Symbol value to a string');
		case 'object':
			var primValue = ToPrimitive(argument, String);
			return ToString(primValue);undefined
		default:
