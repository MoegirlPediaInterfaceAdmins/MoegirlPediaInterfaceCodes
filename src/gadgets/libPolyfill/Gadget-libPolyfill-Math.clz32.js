 ...
 * Options:
 *     polyfillFeature: Math.clz32
 *     polyfillAliases: es6, es2015
 *     browserslist: defaults, Chrome >= 132
 *     polyfillBrowsers: android: <5, bb: *, chrome: <38, edge: <12, edge_mob: <12, firefox: <31, ie: *, ie_mob: *, ios_chr: *, ios_saf: <7, opera: <25, op_mob: *, op_mini: *, safari: <7, firefox_mob: <31
 */
(() => {

// Polyfill Math.clz32 start
