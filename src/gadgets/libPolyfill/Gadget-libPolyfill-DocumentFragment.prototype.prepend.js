 ...
 * Options:
 *     polyfillFeature: DocumentFragment.prototype.prepend
 *     polyfillAliases: default-3.4, default-3.5, default-3.6, default
 *     browserslist: defaults, Chrome >= 132
 *     polyfillBrowsers: android: *, bb: *, chrome: <54, edge: <17, edge_mob: <17, firefox: <49, ios_chr: *, ios_saf: <10, ie: >=8, ie_mob: >=10, opera: <39, op_mini: *, safari: <10, firefox_mob: <49, samsung_mob: <6
 */
(() => {

// Polyfill DocumentFragment.prototype.prepend start
...
// Polyfill DocumentFragment start
...
// Polyfill DocumentFragment.prototype.prepend end
