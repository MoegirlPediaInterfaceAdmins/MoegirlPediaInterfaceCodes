 ...
 * Options:
 *     polyfillFeature: String.prototype.replaceAll
 *     polyfillAliases: es2021
 *     browserslist: defaults, Chrome >= 132
 *     polyfillBrowsers: android: *, bb: *, chrome: <85, edge: <85, edge_mob: <85, firefox: <77, ios_chr: <13.4, ios_saf: <13.4, ie: *, ie_mob: *, opera: <71, op_mini: *, safari: <13.1, firefox_mob: <79, samsung_mob: *
 */
(() => {

// Polyfill String.prototype.replaceAll start
...
// Polyfill _ESAbstract.GetSubstitution start
...
// Polyfill _ESAbstract.GetSubstitution end
...
// Polyfill _ESAbstract.StringIndexOf start
...
// Polyfill _ESAbstract.StringIndexOf end
...
// Polyfill String.prototype.replaceAll end
