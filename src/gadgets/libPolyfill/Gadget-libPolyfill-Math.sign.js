 ...
 * Options:
 *     polyfillFeature: Math.sign
 *     polyfillAliases: es6, es2015
 *     browserslist: defaults, Chrome >= 132
 *     polyfillBrowsers: android: <5, bb: *, chrome: <38, edge: <12, edge_mob: <12, firefox: <25, ie: *, ie_mob: *, ios_chr: *, ios_saf: <9, opera: <25, op_mob: *, op_mini: *, safari: <9, firefox_mob: <25
 */
(() => {

// Polyfill Math.sign start
