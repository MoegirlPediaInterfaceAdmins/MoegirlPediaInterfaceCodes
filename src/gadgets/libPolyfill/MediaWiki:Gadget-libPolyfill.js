...
*/
    ...
    // 1. If method is not present, then
        ...
        const method = arguments.length > 1 ? arguments[1] : GetMethod(obj, Symbol.iterator);
        ...
        const iteratorRecord = Object.create(null);
    ...
    const AddEntriesFromIterable = (function() {
        ...
        // 1. If IsCallable(adder) is false, throw a TypeError exception.
            ...
            // a. Let next be ? IteratorStep(iteratorRecord).
                ...
                // i. Let error be ThrowCompletion(a newly created TypeError object).
                    const error = new TypeError("nextItem is not an object");
    ...
    function ToPrimitive(input /* [, PreferredType] */) { // eslint-disable-line no-unused-vars
        const PreferredType = arguments.length > 1 ? arguments[1] : undefined;
        ...
        // a. If PreferredType is not present, let hint be "default".
            ...
            const exoticToPrim = typeof self.Symbol === "function" && typeof self.Symbol.toPrimitive === "symbol" ? GetMethod(input, self.Symbol.toPrimitive) : undefined;
...
*/
    ...
    */
    ...
    CreateMethodProperty(Object, "fromEntries", (iterable) => {
    // 1. Perform ? RequireObjectCoercible(iterable).
        ...
        const adder = function (key, value) {
