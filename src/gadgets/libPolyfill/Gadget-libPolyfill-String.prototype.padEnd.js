 ...
 * Options:
 *     polyfillFeature: String.prototype.padEnd
 *     polyfillAliases: es7, es2016, es2017
 *     browserslist: defaults, Chrome >= 132
 *     polyfillBrowsers: android: *, bb: *, chrome: <57, firefox: <48, opera: <44, safari: <10, edge: <15, edge_mob: <15, ie: *, ie_mob: *, ios_saf: <10, firefox_mob: <48, samsung_mob: *
 */
(() => {

// Polyfill String.prototype.padEnd start
...
// Polyfill String.prototype.padEnd end
