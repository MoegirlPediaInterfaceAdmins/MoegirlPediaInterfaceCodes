    ...
    const previewers = {
        ...
        gradient: {
            create: (function () {
				 ...
				 */
                const convertToW3CLinearGradient = (prefix, func, values) => {
				 ...
				 * @param {string[]} values Array of the gradient function parameters (["0deg", "red 0%", "blue 100%"])
				 */
                const convertToW3CRadialGradient = (prefix, func, values) => {
				 ...
				 */
                const convertToW3CGradient = (gradient) => {
                    if (cache[gradient]) {
