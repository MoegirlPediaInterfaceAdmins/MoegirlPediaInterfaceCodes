...
(function () {
    ...
    if (window.moment && window.moment.version === undefined && window.moment.default) {
    ...
    //  return moment;
    // }
    let VERSION = "0.5.33", zones = {}, links = {}, countries = {}, names = {}, guesses = {}, cachedGuess;
    if (!window.moment || typeof moment.version !== "string") {
    ...
    ************************************/
    ...
    Zone.prototype = {
        ...
        _index: function (timestamp) {
            let target = +timestamp, untils = this.untils, i;
        ...
        countries: function () {
            ...
            return Object.keys(countries).filter((country_code) => {
                return countries[country_code].zones.indexOf(zone_name) !== -1;
            });
        },
        parse: function (timestamp) {
            let target = +timestamp, offsets = this.offsets, untils = this.untils, max = untils.length - 1, offset, offsetNext, offsetPrev, i;
            for (i = 0; i < max; i++) {
                offset = offsets[i];
    ...
    ************************************/
    ...
    function userOffsets() {
        let startYear = new Date().getFullYear() - 2, last = new OffsetAt(new Date(startYear, 0, 1)), offsets = [last], change, next, i;
        for (i = 1; i < 48; i++) {
    ...
    function guessesForUserOffsets(offsets) {
        let offsetsLength = offsets.length, filteredGuesses = {}, out = [], i, j, guessesOffset;
    ...
    ************************************/
    function tz(input) {
        const args = Array.prototype.slice.call(arguments, 0, -1), name = arguments[arguments.length - 1], zone = getZone(name), out = moment.utc.apply(null, args);
    ...
    ************************************/
    ...
    moment.updateOffset = function (mom, keepTime) {
        let zone = moment.defaultZone, offset;
        if (mom._z === undefined) {
