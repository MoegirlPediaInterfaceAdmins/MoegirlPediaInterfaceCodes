...
(function (factory) {
    ...
    const Mutex = /** @class */ (function () {
        function Mutex() {
            this.mutex = Promise.resolve();
        }
        Mutex.prototype.lock = function () {
            let begin = function () { };
            this.mutex = this.mutex.then(() => { return new Promise(begin); });
    ...
    function WASMInterface(binary, hashLength) {
        return __awaiter(this, void 0, void 0, function () {
            let wasmInstance, memoryView, initialized, writeMemory, getMemory, getExports, setMemorySize, getStateSize, loadWASMPromise, setupInterface, init, updateUInt8Array, update, digestChars, digest, save, load, isDataShort, canSimplify, calculate;
            const _this = this;
            return __generator(this, (_b) => {
                switch (_b.label) {
                    case 0:
                        ...
                        loadWASMPromise = wasmMutex.dispatch(() => { return __awaiter(_this, void 0, void 0, function () {
                            let asm, promise, module;
                            return __generator(this, (_b) => {
                                switch (_b.label) {
                                    case 0:
    ...
    function md5(data) {
        ...
        try {
            const hash_1 = wasmCache$e.calculate(data);
    ...
    function sha1(data) {
        ...
        try {
            const hash_2 = wasmCache$d.calculate(data);
    ...
    function sha3(data, bits) {
        ...
        try {
            const hash_3 = wasmCache$c.calculate(data, bits, 0x06);
    ...
    function sha224(data) {
        ...
        try {
            const hash_4 = wasmCache$a.calculate(data, 224);
    ...
    function sha256(data) {
        ...
        try {
            const hash_5 = wasmCache$9.calculate(data, 256);
    ...
    function sha384(data) {
        ...
        try {
            const hash_6 = wasmCache$8.calculate(data, 384);
    ...
    function sha512(data) {
        ...
        try {
            const hash_7 = wasmCache$7.calculate(data, 512);
    ...
    function sm3(data) {
        ...
        try {
            const hash_8 = wasmCache.calculate(data);
