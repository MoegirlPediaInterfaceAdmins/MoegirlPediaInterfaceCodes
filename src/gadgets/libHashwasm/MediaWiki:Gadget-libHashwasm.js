 ...
 *     exports: [ "createMD5", "createSHA1", "createSHA224", "createSHA256", "createSHA3", "createSHA384", "createSHA512", "createSM3", "md5", "sha1", "sha224", "sha256", "sha3", "sha384", "sha512", "sm3" ]
 */
!function() {
    var _$indexEsm_2 = {};
    (function(global) {
        !function() {
            ...
            const nodeBuffer = null != (_a = globalObject.Buffer) ? _a : null, textEncoder = globalObject.TextEncoder ? new globalObject.TextEncoder() : null;
            ...
            const alpha = "a".charCodeAt(0) - 10, digit = "0".charCodeAt(0);
            ...
            const getUInt8Buffer = null !== nodeBuffer ? data => {
                var buf;
            ...
            const MAX_HEAP = 16384, WASM_FUNC_HASH_LENGTH = 4, wasmMutex = new Mutex(), wasmModuleCache = new Map();
            function WASMInterface(binary, hashLength) {
                return __awaiter(this, void 0, void 0, function*() {
                    ...
                    const getStateSize = () => {
                        return new DataView(wasmInstance.exports.memory.buffer).getUint32(wasmInstance.exports.STATE_SIZE, !0);
                    }, loadWASMPromise = wasmMutex.dispatch(() => __awaiter(this, void 0, void 0, function*() {
                    ...
                    const isDataShort = data => "string" == typeof data ? data.length < MAX_HEAP / 4 : data.byteLength < MAX_HEAP;
