...
$(() => (async () => {
    ...
    $("#mw-content-text > .mw-htmlform-ooui-wrapper").after(`<span class="cdx-card"><span class="cdx-card__text"><span class="cdx-card__text__title">链入情况</span><span class="cdx-card__text__description"><a href="/Special:Search/${encodeURIComponent(`linksto:"${target}" insource:"${target}"`)}" target="_blank" class="external text">通过搜索查找链入</a></span><button id="queryWhatlinkshere" class="cdx-button cdx-button--action-progressive">点此查询链入情况</button><p id="whatlinkshere" style="display: none;">加载中……</p></span></span><span class="cdx-card"><span class="cdx-card__text"><span class="cdx-card__text__title">嵌入情况</span><span class="cdx-card__text__description"><a href="/Special:Search/${encodeURIComponent(`hastemplate:"${target}" insource:"${title}"`)}" target="_blank" class="external text">通过搜索查找嵌入</a></span><button id="queryWhatembeddedin" class="cdx-button cdx-button--action-progressive">点此查询嵌入情况</button><p id="whatembeddedin" style="display: none;">加载中……</p></span></span>`);
