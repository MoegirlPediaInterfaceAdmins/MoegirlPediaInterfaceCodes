...
await artifactClient.uploadArtifact("test", [
    path.join(process.env.RUNNER_TEMP, "test", "env.json"),
    path.join(process.env.RUNNER_TEMP, "test", "event.json"),
], path.join(process.env.RUNNER_TEMP, "test"));
